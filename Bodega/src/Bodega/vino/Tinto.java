...
public abstract class Tinto extends Vino {
     ...
     */
    public Tinto(String nombreVino, String tipoVino, int lote, int anoElaboracion, String etapaActual, float temperaturaFermentacion, float tiempoCrianza, float tiempoMaceracion) {
