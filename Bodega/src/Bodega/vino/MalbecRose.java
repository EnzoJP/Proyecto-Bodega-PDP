 ...
 */
public class MalbecRose extends Rosado implements Prints {
    //Atributos
     ...
     */
    public MalbecRose(int lote, int anoElaboracion, String etapaActual) {
        super("Malbec Rose", "Rosa", lote, anoElaboracion, etapaActual, 0, 0, 0);
    }
