 ...
 *
 */
public class BlendVinoSabroso extends Blend implements Prints{
    //Atributos
     ...
     */
    public BlendVinoSabroso(int lote, int anoElaboracion, String etapaActual) {
        super("Blend VinoSabroso", "Blend", lote, anoElaboracion, etapaActual, 0, 0, 0);
    }
