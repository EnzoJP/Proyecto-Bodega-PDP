...
public abstract class Cava extends Vino {
     ...
     */
    public Cava(String nombreVino, String tipoVino, int lote, int anoElaboracion, String etapaActual, float temperaturaFermentacion, float tiempoCrianza, float tiempoMaceracion) {
