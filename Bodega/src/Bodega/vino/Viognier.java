 ...
 */
public class Viognier extends Blanco implements Prints{
    //Atributos
     ...
     */
    public Viognier(int lote, int anoElaboracion, String etapaActual) {
        super("Viognier", "Blanco", lote, anoElaboracion, etapaActual, 0, 0, 0);
    }
