package Bodega.vino;
/**
 * Clase del vino Cabernet Sauvignon Rose. Posee las temperaturas y tiempos por defectos propios de la clase
 * @version 1.0.0
...
public class CabernetSauvignonRose extends Rosado implements Prints {
     ...
     */
    public CabernetSauvignonRose(int lote, int anoElaboracion, String etapaActual) {
        super("Cabernet Sauvignon Rose", "Rosa", lote, anoElaboracion, etapaActual, 0, 0, 0);
    }
    ...
    public void printCaracteristicas() {
        ...
        System.out.println("Es de un elegante y alegre color cereza madura. Se destacan aromas perfumados de ciruela, cereza y fresa sobre un fondo de pomelo.");
        System.out.println("En boca se muestra un gran cuerpo y fina acidez. De evolución sensual y elegante que culmina con un posgusto prolongado.");
    }
}
