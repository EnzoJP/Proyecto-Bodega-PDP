...
public abstract class Blanco extends Vino {
     ...
     */
    public Blanco(String nombreVino, String tipoVino, int lote, int anoElaboracion, String etapaActual, float temperaturaFermentacion, float tiempoCrianza, float tiempoMaceracion) {
