...
public class SauvignonBlanc extends Vino{
    //Atributos
    ...
    //Constructor
    public SauvignonBlanc(int lote, int anoElaboracion, String etapaActual) {
        super("Sauvignon Blanc", "Blanco", lote, anoElaboracion, etapaActual, 0, 0, 0);
