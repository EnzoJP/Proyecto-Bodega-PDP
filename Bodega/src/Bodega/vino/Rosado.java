...
public abstract class Rosado extends Vino {
     ...
     */
    public Rosado(String nombreVino, String tipoVino, int lote, int anoElaboracion, float temperaturaFermentacion, float tiempoCrianza, float tiempoMaceracion, String maridaje) {
        ...
        //16
        this.listadoEtapas = new String[]{"Recoleccion", "Transporte", "Reparticion", "Despalillado", "Desfangado", "TrasladoSolidos", "Maceracion", "FermentacionAlcoholica", "FermentacionVirgen", "Trasiego", "Clarificacion", "Mezcla", "Estabilizacion", "Crianza", "Embotellado", "Venta"};
    }
}
